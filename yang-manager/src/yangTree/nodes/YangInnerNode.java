...
public abstract class YangInnerNode extends YangNode {
	 ...
	 * @param nodes : the new list of children of this node.
	 */
	...
	/**
	 * Marks a specific child to be deleted. This operation will be performed at next "apply modifications" action.
	 * @param childToDelete : the node to delete. It <u>must</u> be a child of this <code>YangInnerNode</code> .
	 */
