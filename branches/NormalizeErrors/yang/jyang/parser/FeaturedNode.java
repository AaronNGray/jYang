...
public abstract class FeaturedNode extends StatuedNode {
	...
	public boolean isBracked() {
		return super.isBracked() || b_when || ifFeatures.size() != 0 || datadefs.size() != 0;
	}
	...
	public String toString() {
		...
		for (Enumeration<YANG_IfFeature> eifs = ifFeatures.elements(); eifs.hasMoreElements();)
			result += eifs.nextElement().toString() + "\n";
		for (Enumeration<YANG_DataDef> eddefs = datadefs.elements(); eddefs.hasMoreElements();)
